...
wiersheark のファイル`winpeer.pcapng`において`tcp.stream eq 257 and ip.src == 10.40.251.11`の絞り込みで行っている通信を見つけて欲しい
そして`ip.addr = 10.40.251.11`が行っている通信をコピーして全く同じ通信を行うようにして欲しい

とりあえず行っている通信全てを抽出するコードを書いてください
